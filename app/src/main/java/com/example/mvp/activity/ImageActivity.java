...
public class ImageActivity extends AppCompatActivity {
    ...
    public void onViewClicked() {
        ...
        RetrofitHlper.getInstance().chenge(BaseApi.Dowanload);
        Observable<ResponseBody> observable = RetrofitHlper.getInstance().getApi().getDolwanload(getIntent().getStringExtra("url"));
